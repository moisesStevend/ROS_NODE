...
cap = cv2.VideoCapture('/home/meza/Documents/opencv/filtros/videos/peopleCounter.avi')
...
##ROS
rospy.init_node('camara_1')
pub = rospy.Publisher('counter_people', String, queue_size=10)
                    ...
                    for i in persons:
                        if abs(cx-i.getX()) <= w and abs(cy-i.getY()) <= h:
                            ...
                            if i.going_UP(line_down,line_up) == True:
                                ...
                                #data
                                data={
    										"data_salida": str(cnt_down),
    										"data_entrada": str(cnt_up)
    								}
                                pub.publish(json.dumps(data))
    							#client.publish("data_time", json.dumps(data))
